...
<div class="my-body">
    ...
    <form action="${pageContext.request.contextPath}/api/merchant/selectUncheckMerchantByKey?page=1" method="post">
        <div class="demoTable">
            搜索用户：
                ...
                <tr>
                    ...
                    <td>
                        <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail"
                           href="${pageContext.request.contextPath}/api/merchant/selectUncheckMerchantByMerchantname?name=${merchantinfo.merchantname}">查看</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
    ...
    <nav aria-label="Page navigation" class="pager" style="padding: 0px 20px;">
        <ul class="pagination">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/api/merchant/selectUncheckMerchant?page=${pagemsg.navigateFirstPage}">首页</a>
            </li>
            <c:if test="${pagemsg.pageNum>=2}">
                <li>
                    <a href="${pageContext.request.contextPath}/api/merchant/selectUncheckMerchant?page=${pagemsg.prePage}"
            ...
            <c:forEach var="s" begin="1" end="${pagemsg.pages}">
                <li>
                    <a href="${pageContext.request.contextPath}/api/merchant/selectUncheckMerchant?page=${s}">${s}</a>
                </li>
            </c:forEach>
            <c:if test="${pagemsg.pageNum<pagemsg.navigateLastPage}">
                <li>
                    <a href="${pageContext.request.contextPath}/api/merchant/selectUncheckMerchant?page=${pagemsg.nextPage}"
            ...
            <li>
                <a href="${pageContext.request.contextPath}/api/merchant/selectUncheckMerchant?page=${pagemsg.navigateLastPage}">尾页</a>
            </li>
